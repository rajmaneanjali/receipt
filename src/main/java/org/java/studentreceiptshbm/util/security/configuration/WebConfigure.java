package org.java.studentreceiptshbm.util.security.configuration;

import java.util.ArrayList;
import java.util.List;

import org.java.studentreceiptshbm.util.security.admin.SessionHandler;
import org.java.studentreceiptshbm.util.security.admin.impl.SessionHandlerImpl;
import org.java.studentreceiptshbm.util.security.intercptor.AuthorizationInterceptor;
...
public class WebConfigure extends WebMvcConfigurerAdapter {
    ...
    public AuthorizationInterceptor authorizationInterceptor() {
        ...
        bypassUrlList.add("/v1/admin/register");
